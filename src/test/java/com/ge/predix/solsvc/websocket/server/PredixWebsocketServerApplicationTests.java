...
public class PredixWebsocketServerApplicationTests {
    ...
    public void setup()
    {
        ...
        System.out.println("URI : "+this.testWebSocketConfig.getWsUri()); //$NON-NLS-1$
        this.client.init(this.testWebSocketConfig, emptyHeaders, this.messageListener);
        this.clientError.init(this.testWebSocketConfig, emptyHeaders, this.messageListenerError);
    }
